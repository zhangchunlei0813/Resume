...
<<<<<<< HEAD
\address{2400 4th AVE Apt 554, Seattle, WA, 98121} % Your phone number and email
=======
\address{2400 4th Ave, Seattle, WA, 98121} % Your phone number and email
>>>>>>> aeee92e61e47f5d9c43916a3d648ae634b7e7bfb
...
Relevant Courses: Data Analysis, Regression and Least Squares Analysis, Statistic Method, Machine Learning, Convolutional Neural Networks for Visual Recognition,
Linear Programming, Nonlinear Programming, Discrete Optimization, Stochastic Process
...
\begin{rSection}{Data Science Projects}	
	\begin{rSubsection}{Identifying Authors of Emails (Text Classification)}
			{Feb 2019 - Mar 2019}{Course Project in Python}{Clemson University}		
			\setlength{\parindent}{2em} \item Preprocessed text data including stemming words with NLTK, text vectorization with TfidfVectorizer, splitting training/testing sets with sklearn 
			\item Fitted models using Naive Bayes, Logistic Regression, Support Vector Machine (SVM), Decision Tree, Random Forest, and AdaBoost on training set
			\item Chosen hyperparameters on validation sets and evaluated obtained models on testing set via confusion matrix including accuracy, precision, recall, etc
	\end{rSubsection}	
...
\begin{rSection}{Skills}
  \begin{list}{$\bullet$}{\leftmargin=1.0em}
  	\item Fluent: Python (NumPy, pandas, Matplotlib, scikit-learn), Matlab, R, Git, Latex 
  	\item In Training: Java, Hadoop, MapReduce, Python (Keras, Tensorflow), SQL
  	\end{list}
\end{rSection}
